...
mod test {
    ...
    fn test_kinds() {
        ...
        assert!(!Kind::KEY_SCHEDULE.content_is_printable());
        ...
        assert!(!Kind::PROFILE.content_is_printable());
        ...
        assert!(Kind::MICROBLOG_ROOT.content_is_printable());
        ...
        assert!(Kind::REPLY_COMMENT.content_is_printable());
        ...
        assert!(Kind::BLOG_POST.content_is_printable());
        ...
        assert!(Kind::CHAT_MESSAGE.content_is_printable());
    }
}
